 ...
 *
 * Implementation of "RBMCF_OPENMP.h".
 *
...
RBMCF_OPENMP::RBMCF_OPENMP() : RBMCF() {
    // Nothing more to do
}

RBMCF_OPENMP::RBMCF_OPENMP(string filename) : RBMCF(filename) {
    // Nothing more to do
}

RBMCF_OPENMP::~RBMCF_OPENMP() {
    // Nothing more to do
}
...
void RBMCF_OPENMP::train(string dataset, bool reset) {
    // Pop parameters
